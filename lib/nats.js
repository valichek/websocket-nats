...
function NatsError(message, code, chainedError) {
    ...
    // Error.captureStackTrace(this, this.constructor); // _NODE_
    // this.name = this.constructor.name; // _NODE_
    // this.message = message; // _NODE_
    // this.code = code; // _NODE_
    // this.chainedError = chainedError; // _NODE_
    ...
    if(Error.captureStackTrace) {
      ...
      Object.defineProperty(this, 'chainedError', {
        configurable: true,
        enumerable: false,
        value: chainedError
      });
...
Client.prototype.createConnection = function() {
    ...
    if (this.url.protocol.indexOf('ws') === -1) {
        // TODO: nodejs: host contains port by default, so we should remove it
        this.url.host = this.url.host && this.url.host.split(':')[0]
      }
